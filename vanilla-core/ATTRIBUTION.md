...
```
Built on Vanilla Core — © Shibbieness / M MAOU LLC
```
...
Vanilla Core awkward to depend on.
...
one onto the free license would push Vanilla Core out of GPL compatibility
